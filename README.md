...
Of the 5 forms that ICM Templates fall under this is an "Umbrella" it 
not only has a pipeline/workflow it has `feedback/` to store each session
that went thorugh the workflow. This ICM Template would not work well as 
a pipeline alone because of the shared experience framming that is required 
